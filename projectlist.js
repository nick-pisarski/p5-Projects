...
const PROJECT_LIST = [
  ...
  new Project( "Cannon", "A project to create a cannon to shoot projectiles.", "Cannon" ),
  new Project( "Chaos Game", "Creation of the Chaos Game. Need to add HTML elements to control various aspects.",
    "ChaosGame",
    [
  ...
  new Project( "Lissajous Curves *", "A recreation of the Lissajous Curve Table", "LissajousCurve",
    [
